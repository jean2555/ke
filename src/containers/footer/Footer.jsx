...
const Footer = () => {
  return (
    <div className='wrapper'>
      <div className='row'>
        <div className='row__foo'>

          <nav aria-label='Footer navigation' className='row'>
            <div className='col1'>
              <span className='Top'>Démarrer</span>

              <ul className='list'>
                <li className='baseline-hi'>
                  <a href='/try-now'> Essayer gratuitement</a>
                </li>

                <li className='baseline-hi'>
                  <a href='/download'> Télécharger skeez</a>
                </li>

                <li className='baseline-hi'>
                  <a href='/price'> Prix et abonnement</a>
                </li>
          ...
          <nav aria-label='Footer navigation' className='row'>
            <div className='col1'>
              <span className='Top'>A propos de nous</span>

              <ul className='list'>
                <li className='baseline-hi'>
                  <a href='/try-now'> Programme d'affiliation</a>
                </li>

                <li className='baseline-hi'>
                  <a href='/download'> For artist</a>
                </li>

                <li className='baseline-hi'>
                  <a href='/price'> For music</a>
                </li>
          ...
          <nav aria-label='Footer navigation' className='row'>
            <div className='col1'>
              <span className='Top'>S'abonner</span>

              <ul className='list'>
                <li className='baseline-hi'>
                  <a href='/try-now'> Entrer le code promo</a>
                </li>

                <li className='baseline-hi'>
                  <a href='/download'> Entrer un bon cadeau</a>
                </li>

                <li className='baseline-hi'>
                  <a href='/price'> Gérer mon compte</a>
                </li>
          ...
          <div className='layout'>
            ...
            <a href="/try-now" class="btn-primary-outline">Essayer gratuitement</a>
        ...
        <div className='skeez-end'>

          <span className='end'> TIDAL est le premier service de streaming avec un son en HIFI, des vidéos en HD, des playlists élaborées par des experts. Avec ses émissions produites pour le service, TIDAL est une vraie source de contenu musical et de culture.</span>
        </div>
      </div>
